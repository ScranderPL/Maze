...
if algorithm == 1:
    ...
    print("Is it equal to initial message:", message == decoded_message)

    if message != decoded_message:
        print("Is initial message starts with decoded message at least:", message.startswith(decoded_message))
